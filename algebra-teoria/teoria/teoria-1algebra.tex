\section{Unidade 1: conjuntos, relaciones y funciones}


\textbf{Relaciones:}

\begin{teoria}
si A y B son dos conjuntos, una relación $R$ de $A$ en $B$ es un subconjunto cualquiera R del producto cartesiano $A \times B$. Es decir, $R \subseteq A \times B$ o $R \in P (A \times B)$.
\end{teoria}
