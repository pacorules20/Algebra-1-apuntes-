...
\section{Propiedades de la suma y el producto en \texorpdfstring{$\mathbb{Z}$}{Z}}
\begin{teoria}
...
\section{Congruencia módulo \texorpdfstring{$m$}{m}}
...
$a \equiv c \pmod m$ y $(a,c) \in R$. Por lo tanto $R$ es transitiva.

Como $R$ es reflexiva, simétrica y transitiva, es una relación de
equivalencia en $\mathbb{Z}$.
\end{demostracion}